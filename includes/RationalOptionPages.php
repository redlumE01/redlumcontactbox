...
class RationalOptionPages {
	...
	protected function build_menu_page( $page_key ) {
		...
		if ( !empty( $page['sections'] ) ) { ?>
			<form action="options.php" method="post" style="background-color: #FFF;padding: 0.5em 1em;margin-top: 10px;border: 1px solid #ccd0d4;box-shadow: 0 1px 1px rgba(0,0,0,.04);">
				<?php
